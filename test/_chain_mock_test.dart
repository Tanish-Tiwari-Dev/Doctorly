...
class MockOrderBuilder<T> extends Mock implements PostgrestTransformBuilder<T> {}
...
void main() {
  test('chain mock setup', () {
    ...
    when(() => mockFilterBuilder.order(any(), ascending: any(named: 'ascending'))).thenAnswer((_) => mockOrderBuilder);
